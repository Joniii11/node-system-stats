[node-system-stats](../README.md) / [Exports](../modules.md) / SystemMonitor

# Class: SystemMonitor

System monitoring class that collects and tracks system metrics
 'data' - Emitted when new system data is collected with SystemSnapshot as the payload
...
- [constructor](SystemMonitor.md#constructor)

### Properties

- [isRunning](SystemMonitor.md#isrunning)
- [options](SystemMonitor.md#options)
- [snapshots](SystemMonitor.md#snapshots)
- [timer](SystemMonitor.md#timer)
- [captureRejectionSymbol](SystemMonitor.md#capturerejectionsymbol)
- [captureRejections](SystemMonitor.md#capturerejections)
- [defaultMaxListeners](SystemMonitor.md#defaultmaxlisteners)
- [errorMonitor](SystemMonitor.md#errormonitor)

### Methods

- [[captureRejectionSymbol]](SystemMonitor.md#[capturerejectionsymbol])
- [addListener](SystemMonitor.md#addlistener)
- [clearHistory](SystemMonitor.md#clearhistory)
- [emit](SystemMonitor.md#emit)
- [eventNames](SystemMonitor.md#eventnames)
- [getCpuStats](SystemMonitor.md#getcpustats)
- [getCurrentSnapshot](SystemMonitor.md#getcurrentsnapshot)
- [getMaxListeners](SystemMonitor.md#getmaxlisteners)
- [getMemoryStats](SystemMonitor.md#getmemorystats)
- [getSnapshots](SystemMonitor.md#getsnapshots)
- [isActive](SystemMonitor.md#isactive)
- [listenerCount](SystemMonitor.md#listenercount)
- [listeners](SystemMonitor.md#listeners)
- [off](SystemMonitor.md#off)
- [on](SystemMonitor.md#on)
- [once](SystemMonitor.md#once)
- [prependListener](SystemMonitor.md#prependlistener)
- [prependOnceListener](SystemMonitor.md#prependoncelistener)
- [rawListeners](SystemMonitor.md#rawlisteners)
- [removeAllListeners](SystemMonitor.md#removealllisteners)
- [removeListener](SystemMonitor.md#removelistener)
- [setMaxListeners](SystemMonitor.md#setmaxlisteners)
- [start](SystemMonitor.md#start)
- [stop](SystemMonitor.md#stop)
- [takeSystemSnapshot](SystemMonitor.md#takesystemsnapshot)
- [addAbortListener](SystemMonitor.md#addabortlistener)
- [getEventListeners](SystemMonitor.md#geteventlisteners)
- [getMaxListeners](SystemMonitor.md#getmaxlisteners-1)
- [listenerCount](SystemMonitor.md#listenercount-1)
- [on](SystemMonitor.md#on-1)
- [once](SystemMonitor.md#once-1)
- [setMaxListeners](SystemMonitor.md#setmaxlisteners-1)

## Constructors

### constructor

• **new SystemMonitor**(`options?`): [`SystemMonitor`](SystemMonitor.md)
...
| :------ | :------ | :------ |
| `options` | [`MonitorOptions`](../interfaces/MonitorOptions.md) | Configuration options |
...
src/utils/monitor.ts:48

___

### options

• `Private` **options**: [`Required`](../modules/internal_.md#required)\<[`MonitorOptions`](../interfaces/MonitorOptions.md)\>

#### Defined in

src/utils/monitor.ts:45

___

### snapshots

• `Private` **snapshots**: [`SystemSnapshot`](../interfaces/internal_.SystemSnapshot.md)[] = `[]`

#### Defined in

src/utils/monitor.ts:46
...
▸ **clearHistory**(): [`SystemMonitor`](SystemMonitor.md)
...
Object with min, max, and average CPU usage
...
src/utils/monitor.ts:145

___

### getCurrentSnapshot

▸ **getCurrentSnapshot**(): ``null`` \| [`SystemSnapshot`](../interfaces/internal_.SystemSnapshot.md)

Get the most recent system snapshot

#### Returns

``null`` \| [`SystemSnapshot`](../interfaces/internal_.SystemSnapshot.md)

The latest system snapshot or null if no snapshots exist

#### Defined in

src/utils/monitor.ts:116
...
set by `emitter.setMaxListeners(n)` or defaults to [defaultMaxListeners](SystemMonitor.md#defaultmaxlisteners).
...
Object with statistics about memory usage

| Name | Type |
| :------ | :------ |
| `free` | \{ `avg`: `number` = 0; `max`: `number` = 0; `min`: `number` = 0 } |
| `free.avg` | `number` |
| `free.max` | `number` |
| `free.min` | `number` |
| `percentUsed` | \{ `avg`: `number` = 0; `max`: `number` = 0; `min`: `number` = 0 } |
| `percentUsed.avg` | `number` |
| `percentUsed.max` | `number` |
| `percentUsed.min` | `number` |
| `used` | \{ `avg`: `number` = 0; `max`: `number` = 0; `min`: `number` = 0 } |
| `used.avg` | `number` |
| `used.max` | `number` |
| `used.min` | `number` |
...
src/utils/monitor.ts:162

___

### getSnapshots

▸ **getSnapshots**(`limit?`): [`SystemSnapshot`](../interfaces/internal_.SystemSnapshot.md)[]
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `limit?` | `number` | Maximum number of snapshots to return (from most recent) |

#### Returns

[`SystemSnapshot`](../interfaces/internal_.SystemSnapshot.md)[]

Array of system snapshots

#### Defined in

src/utils/monitor.ts:125
...
▸ **start**(`includeProcesses?`): [`SystemMonitor`](SystemMonitor.md)
...
| :------ | :------ | :------ | :------ |
| `includeProcesses` | `boolean` | `false` | Whether to include process information in snapshots |
...
src/utils/monitor.ts:67

___

### stop

▸ **stop**(): [`SystemMonitor`](SystemMonitor.md)
...
src/utils/monitor.ts:92

___

### takeSystemSnapshot

▸ **takeSystemSnapshot**(`includeProcesses`): `Promise`\<`void`\>
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `includeProcesses` | `boolean` | Whether to include process information |
