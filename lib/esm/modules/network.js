 ...
 */
export async function startNetworkMonitoring(updateInterval = 1000) {
    try {
        if (!networkMonitor) {
 ...
 */
export function getTotalBytesSent() {
    if (!networkMonitor) {
        return 0;
    }
 ...
 */
export function getTotalBytesReceived() {
    if (!networkMonitor) {
        return 0;
    }
 ...
 */
export async function getPrimaryInterface() {
    try {
        const interfaces = await getNetworkInterfaces();
 ...
 */
export async function getPrimaryIpAddress() {
    try {
