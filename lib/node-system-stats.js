...
exports.showMemoryUsage = exports.avgClockMHz = exports.clockMHz = exports.totalCores = exports.usagePercent = void 0;
...
function usagePercent(optsInput) {
    return __awaiter(this, void 0, void 0, function* () {
        let opts = {
            coreIndex: (optsInput === null || optsInput === void 0 ? void 0 : optsInput.coreIndex) || -1,
            sampleMs: (optsInput === null || optsInput === void 0 ? void 0 : optsInput.sampleMs) || 1000,
        };
...
function _error(coreIndex, cores) {
    throw new Error('[cpu-stats] Error: Core "' +
        coreIndex +
